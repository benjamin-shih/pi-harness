...
type TaskRetentionResult = { task_api_version?: number; scope: "project" | "all"; project_scoped?: boolean; policy: { destructive_actions: boolean }; summary: Record<string, number> };
