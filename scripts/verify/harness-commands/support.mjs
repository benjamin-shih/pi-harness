...
export const controlPlaneDecisionPayload = (overrides = {}) => {
	...
	return {
		...
		artifacts: { html: { publish_policy: "explicit_only", source_of_truth: "json_or_markdown", modes: [{ id: "html_report" }], auto_open: { enabled: true, when: "after_local_html_artifact_created", modes: ["html_report"], safety: ["local_file_only", "open_once_per_turn"] }, template: { id: "benjamin_local_v1", path: `${agentsRoot}/shared/templates/html-artifacts/benjamin-local-template.html`, usage: "Reference this template path and fill placeholders/sections instead of regenerating full CSS/JS in prompts.", theme_source: "https://benjamin-shih.github.io/", allowed_components: ["cards", "tabs", "range_sliders", "sortable_tables"] }, templates: [{ id: "benjamin_local_v1" }, { id: "benjamin_report_v1" }, { id: "benjamin_dashboard_v1" }, { id: "benjamin_article_v1" }], safety: ["no_raw_prompts_or_transcripts"] } },
		checks: ["make verify"],
